...
El sistema operativo detectado es un _Creston_, el cual se encarga de controlar interfaces gráficas, gestionar eventos, redes... Los _scripts_, por su parte, no han desvelado ningún tipo de información importante.

Así pues, primero nos dirigimos desde el navegador al puerto 80 de la IP dada y esta nos lleva a una página con una pantalla de comandos para interactuar. Cada uno de estos muestra diferentes vídeos y fotografías relacionadas con la serie de televisión.
...
Como es costumbre se verifica el archivo '/robots.txt', el cual nos muestra la primera de las _flags_ dentro del archivo de texto _key-1-of-3.txt_. Para obtenerla solo hay que dirigrse a la dirección 'http://10.10.57.46/key-1-of-3.txt'.
